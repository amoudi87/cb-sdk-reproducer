...
public class SporadicIllegalReferenceCountExceptionTest {
    ...
    public void test() throws Exception {
        ...
        run(PB.command("docker-compose -f /data/cb-sdk-reproducer/src/test/resources/docker/docker-compose.yml up -d")
                .start());
        ...
        // Teardown cluster
        run(PB.command("docker-compose -f /data/cb-sdk-reproducer/src/test/resources/docker/docker-compose.yml down")
                .start());
    }
